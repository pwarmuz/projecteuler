...
// findN will find the limit of loops, it's a fibonacci limit
...
// SumTotal will use the Fibonacci function to find the sum total up to some limit, defined as limit,
...
// Sequence returns the fibonacci sequence of entries
